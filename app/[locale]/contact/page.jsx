...
const contactInfoKeys = [
  {
    ...
    titleKey: 'emailTitle',
    valueKey: 'emailValue',
    link: 'mailto:hello@ghostpost.ai'
  },
  {
    icon: 'phone',
    titleKey: 'phoneTitle',
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.container}>
          <Badge>{t.badge || "24/7 Support"}</Badge>
        ...
        <div className={styles.container}>
          <div className={styles.contactGrid}>
            ...
            <div className={styles.infoColumn}>
              <h2 className={styles.infoTitle}>{t.infoTitle || "Contact Information"}</h2>
              <p className={styles.infoDescription}>
                {t.infoDescription || "Fill out the form and our team will get back to you within 24 hours."}
              </p>

              <div className={styles.infoCards}>
                {contactInfoKeys.map((item) => (
                  <div key={item.titleKey} className={styles.infoCard}>
                    ...
                    <div className={styles.infoContent}>
                      ...
                      {item.link ? (
                        ...
                        <span className={styles.infoValue}>{t[item.valueKey] || item.valueKey}</span>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className={styles.socials}>
                <span className={styles.socialsLabel}>{t.followUs || "Follow us"}</span>
