...
export function Footer({ locale, dict }) {
  const productLinks = [
    ...
    { href: `/${locale}/how-it-works`, label: dict?.footer?.links?.howItWorks || "How It Works" },
  ];

  const companyLinks = [
    { href: `/${locale}/about`, label: dict?.footer?.links?.about || "About" },
    { href: `/${locale}/blog`, label: dict?.footer?.links?.blog || "Blog" },
    { href: "#", label: dict?.footer?.links?.careers || "Careers" },
  ];

  const supportLinks = [
    { href: `/${locale}/faq`, label: dict?.nav?.faq || "FAQ" },
    { href: `/${locale}/contact`, label: dict?.footer?.links?.contact || "Contact" },
      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.linkGroup}>
            <h4 className={styles.linkGroupTitle}>{dict?.footer?.product || "Product"}</h4>
          ...
          <div className={styles.linkGroup}>
            <h4 className={styles.linkGroupTitle}>{dict?.footer?.company || "Company"}</h4>
            <ul className={styles.linkList}>
